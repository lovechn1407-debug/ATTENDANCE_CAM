...
export function generateGreetingText(status, studentName = "", style = "friendly") {
  ...
  switch (status) {
    ...
    case "LIVENESS_CHALLENGE":
      if (style === "formal") return `Hello ${firstName}. Please turn your head or smile to verify.`;
      if (style === "brief") return `Please turn head or smile.`;
      return `Hello ${firstName}! Please turn your head slightly or smile to verify attendance.`;
